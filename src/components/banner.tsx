...
export default function Banner({
  ...
  return (
    ...
    <section
      className={`glass-edge relative isolate flex w-full items-end overflow-hidden rounded-3xl shadow-sm [--glass-edge-inset:0px] ${sizeClass}`}
    >
      {imageSrc ? (
        <Image
          src={imageSrc}
      ...
      {/* 文字各自装在半透明毛玻璃方块里：glass-panel 是面板本体，
          面板自带 backdrop-filter，所以描边必须由外面那层 glass-edge 画 */}
